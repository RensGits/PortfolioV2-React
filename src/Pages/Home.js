...
function Home () {
    return (
        ...
        <motion.p className = 'hi' initial = {{y: -100}} animate = {{y:0}} exit = {{y: 0}} transition = {{duration: 0.8}}>Hi! I'm Rens van Driel,
a self taught front-end developer 
with an affinity for biology and 3D. Check out some of my work below or see what i'm learning about in the playground section.</motion.p>
        <motion.p initial = {{y: -100}} animate = {{y:0}} exit = {{y: 0}} transition = {{duration: 0.8}} className = 'cV'><a style = {{fontSize: '1em', color :'#E57070'}} href = {CV} target = '_blank'>Download my CV</a></motion.p>
        <motion.div key = 'projectbody' exit = {{opacity: 0}} className = 'projectBody' >
        <ProjectItem blockright = 'projectBlockRight brownobrown '  link = '/virus' className = 'projectImageThree' image = 'https://i.imgur.com/7hVFTpz.png' duration = '1' projectname = 'Virus - learn something' category = 'Dart / flutter'description = 'VIRUS is a playstore live application that gives information on clinically imortant viruses. Virus was my first ever coding project and taught me a lot about setting up a project to finalising publication.'  />
        ...
        <ProjectItem blockright = 'projectBlockRight sixosix' link = 'naturalis' className = 'projectImageTwo' image = 'https://i.imgur.com/i0lwYR7_d.webp?maxwidth=760&fidelity=grand' duration = '1.4' projectname = 'Naturalis' category = 'Research / 3D modeling' description = 'At Naturalis Biodiversity Centre I did research into the evolutionairy history of two winged insects. Here I worked on 3D moddeling of anatomy and integrating this into scientific publications. '   />
        <ProjectItem blockright = 'projectBlockRight' link = 'somzoa' className = 'projectImageFour'image = 'https://i.imgur.com/Wzd5RhN.png' duration = '1.6' projectname = 'Snippets' category = 'Freelance / hobby' description = 'Graphic design freelance & hobby projects.' />
        </motion.div>
        <Footer />
        </motion.div>
