...
export default function Model(props) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <group name="Camera" position={[10.2, 4.96, 14.93]} rotation={[3.41, 3.19, 2.84]}>
        <PerspectiveCamera makeDefault={false} far={100} near={0.1} fov={24.83} rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      <group name="Cube" >
